...
namespace Pomelo.Data.MyCat
{
    ...
    /// <summary>
    /// Specifies MySQL specific data type of a field, property, for use in a <see cref="MyCatParameter"/>.
    /// </summary>
    public enum MyCatDbType
    {
        /// <summary>
        /// <see cref="Decimal"/>
    ...
    /// be used.
    /// </summary>
    public enum MyCatConnectionProtocol
    {
        /// <summary>
    ...
    public enum MyCatCertificateStoreLocation
    {
        /// <summary>
    ...
    internal class MyCatConnectAttrs
    {
        [DisplayName("_client_name")]
        public string ClientName
        {
            get { return "MyCat Connector/NET"; }
        }
        ...
        public string ClientVersion
        {
            get
            {
                ...
                try
                {
                    version = Assembly.GetAssembly(typeof(MyCatConnectAttrs)).GetName().Version.ToString();
                }
                catch (Exception ex) { System.Diagnostics.Debug.WriteLine(ex.ToString()); }
                return version;
            }
