...
namespace Pomelo.Data.MyCat
{
  ...
  public sealed class MyCatHelper
  {
    ...
    /// <summary>
    /// Executes a single SQL command and returns the first row of the resultset.  A new MyCatConnection object
    ...
    public static DataRow ExecuteDataRow(string connectionString, string commandText, params MyCatParameter[] parms)
    {
    ...
    /// A new MyCatConnection object is created, opened, and closed during this method.
    /// </summary>
    /// <param name="connectionString">Settings to be used for the connection</param>
    /// <param name="commandText">Command to execute</param>
    ...
    public static DataSet ExecuteDataset(string connectionString, string commandText)
    {
      ...
      return ExecuteDataset(connectionString, commandText, (MyCatParameter[])null);
    }
    ...
    /// <returns><see cref="DataSet"/> containing the resultset</returns>
    public static DataSet ExecuteDataset(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      //create & open a SqlConnection, and dispose of it after we are done.
      using (MyCatConnection cn = new MyCatConnection(connectionString))
      {
    ...
    /// <param name="commandText">Command to execute</param>
    /// <returns><see cref="DataSet"/> containing the resultset</returns>
    public static DataSet ExecuteDataset(MyCatConnection connection, string commandText)
    {
      //pass through the call providing null for the set of SqlParameters
      return ExecuteDataset(connection, commandText, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandText">Command text to use</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static MyCatDataReader ExecuteReader(string connectionString, string commandText)
    {
      //pass through the call providing null for the set of SqlParameters
      return ExecuteReader(connectionString, commandText, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandText">Command text to use</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static MyCatDataReader ExecuteReader(MyCatConnection connection, string commandText)
    {
      //pass through the call providing null for the set of SqlParameters
      return ExecuteReader(connection, null, commandText, (MyCatParameter[])null, true);
    }
    ...
    /// <param name="commandParameters">Array of <see cref="MyCatParameter"/> objects to use with the command</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static MyCatDataReader ExecuteReader(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      //call the private overload that takes an internally owned connection in place of the connection string
    ...
    {
      //pass through the call providing null for the set of MyCatParameters
      return ExecuteScalar(connectionString, commandText, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static object ExecuteScalar(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      //create & open a SqlConnection, and dispose of it after we are done.
      using (MyCatConnection cn = new MyCatConnection(connectionString))
      {
    ...
    /// <param name="commandText">Command text to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static object ExecuteScalar(MyCatConnection connection, string commandText)
    {
      //pass through the call providing null for the set of MyCatParameters
      return ExecuteScalar(connection, commandText, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static object ExecuteScalar(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      //create a command and prepare it for execution
      MyCatCommand cmd = new MyCatCommand();
      cmd.Connection = connection;
    ...
    /// <param name="parms">Parameters to use for the command</param>
    /// <returns>DataRow containing the first row of the resultset</returns>
    public static Task<DataRow> ExecuteDataRowAsync(string connectionString, string commandText, params MyCatParameter[] parms)
    {
      return ExecuteDataRowAsync(connectionString, commandText, CancellationToken.None, parms);
    }

    public static Task<DataRow> ExecuteDataRowAsync(string connectionString, string commandText, CancellationToken cancellationToken, params MyCatParameter[] parms)
    {
    ...
    public static Task<int> ExecuteNonQueryAsync(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteNonQueryAsync(connection, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<int> ExecuteNonQueryAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
    ...
    /// <param name="commandParameters">Array of <see cref="MyCatParameter"/> objects to use with the command.</param>
    /// <returns>Rows affected</returns>
    public static Task<int> ExecuteNonQueryAsync(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteNonQueryAsync(connectionString, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<int> ExecuteNonQueryAsync(string connectionString, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
      var result = new TaskCompletionSource<int>();
      if (cancellationToken == CancellationToken.None || !cancellationToken.IsCancellationRequested)
      {
    ...
    {
      return ExecuteDatasetAsync(connectionString, commandText, CancellationToken.None, (MyCatParameter[])null);
    }
    ...
    {
      return ExecuteDatasetAsync(connectionString, commandText, cancellationToken, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns><see cref="DataSet"/> containing the resultset</returns>
    public static Task<DataSet> ExecuteDatasetAsync(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteDatasetAsync(connectionString, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<DataSet> ExecuteDatasetAsync(string connectionString, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
    ...
    /// <param name="commandText">Command to execute</param>
    /// <returns><see cref="DataSet"/> containing the resultset</returns>
    public static Task<DataSet> ExecuteDatasetAsync(MyCatConnection connection, string commandText)
    {
      return ExecuteDatasetAsync(connection, commandText, CancellationToken.None, (MyCatParameter[])null);
    }

    public static Task<DataSet> ExecuteDatasetAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken)
    {
      return ExecuteDatasetAsync(connection, commandText, cancellationToken, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns><see cref="DataSet"/> containing the resultset</returns>
    public static Task<DataSet> ExecuteDatasetAsync(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteDatasetAsync(connection, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<DataSet> ExecuteDatasetAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
      var result = new TaskCompletionSource<DataSet>();
      if (cancellationToken == CancellationToken.None || !cancellationToken.IsCancellationRequested)
      {
    ...
    /// <param name="commandText">Command text to use</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static Task<MyCatDataReader> ExecuteReaderAsync(string connectionString, string commandText)
    {
      return ExecuteReaderAsync(connectionString, commandText, CancellationToken.None, (MyCatParameter[])null);
    }

    public static Task<MyCatDataReader> ExecuteReaderAsync(string connectionString, string commandText, CancellationToken cancellationToken)
    {
      return ExecuteReaderAsync(connectionString, commandText, cancellationToken, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandText">Command text to use</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static Task<MyCatDataReader> ExecuteReaderAsync(MyCatConnection connection, string commandText)
    {
      return ExecuteReaderAsync(connection, null, commandText, (MyCatParameter[])null, true, CancellationToken.None);
    }

    public static Task<MyCatDataReader> ExecuteReaderAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken)
    {
      return ExecuteReaderAsync(connection, null, commandText, (MyCatParameter[])null, true, cancellationToken);
    }
    ...
    /// <param name="commandParameters">Array of <see cref="MyCatParameter"/> objects to use with the command</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static Task<MyCatDataReader> ExecuteReaderAsync(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteReaderAsync(connectionString, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<MyCatDataReader> ExecuteReaderAsync(string connectionString, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
      var result = new TaskCompletionSource<MyCatDataReader>();
      if (cancellationToken == CancellationToken.None || !cancellationToken.IsCancellationRequested)
      {
    ...
    /// <param name="commandParameters">Array of <see cref="MyCatParameter"/> objects to use with the command</param>
    /// <returns><see cref="MyCatDataReader"/> object ready to read the results of the command</returns>
    public static Task<MyCatDataReader> ExecuteReaderAsync(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteReaderAsync(connection, null, commandText, commandParameters, true, CancellationToken.None);
    }

    public static Task<MyCatDataReader> ExecuteReaderAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
    ...
    {
      return ExecuteScalarAsync(connectionString, commandText, CancellationToken.None, (MyCatParameter[])null);
    }
    ...
    {
      return ExecuteScalarAsync(connectionString, commandText, cancellationToken, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static Task<object> ExecuteScalarAsync(string connectionString, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteScalarAsync(connectionString, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<object> ExecuteScalarAsync(string connectionString, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
    ...
    /// <param name="commandText">Command text to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static Task<object> ExecuteScalarAsync(MyCatConnection connection, string commandText)
    {
      return ExecuteScalarAsync(connection, commandText, CancellationToken.None, (MyCatParameter[])null);
    }

    public static Task<object> ExecuteScalarAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken)
    {
      return ExecuteScalarAsync(connection, commandText, cancellationToken, (MyCatParameter[])null);
    }
    ...
    /// <param name="commandParameters">Parameters to use for the command</param>
    /// <returns>The first column of the first row in the result set, or a null reference if the result set is empty.</returns>
    public static Task<object> ExecuteScalarAsync(MyCatConnection connection, string commandText, params MyCatParameter[] commandParameters)
    {
      return ExecuteScalarAsync(connection, commandText, CancellationToken.None, commandParameters);
    }

    public static Task<object> ExecuteScalarAsync(MyCatConnection connection, string commandText, CancellationToken cancellationToken, params MyCatParameter[] commandParameters)
    {
      var result = new TaskCompletionSource<object>();
      if (cancellationToken == CancellationToken.None || !cancellationToken.IsCancellationRequested)
      {
