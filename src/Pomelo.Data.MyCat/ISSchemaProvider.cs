...
namespace Pomelo.Data.MyCat
{
  ...
  {
    public ISSchemaProvider(MyCatConnection connection)
      : base(connection)
    {
    }
    ...
    private MyCatSchemaCollection GetParametersFromIS(string[] restrictions, MyCatSchemaCollection routines)
    {
      ...
      else foreach (MyCatSchemaRow routine in routines.Rows)
        {
          if (restrictions != null && restrictions.Length >= 3)
    ...
    /// </summary>
    public virtual MyCatSchemaCollection GetProcedureParameters(string[] restrictions,
        MyCatSchemaCollection routines)
    {
      ...
      try
      {
        ...
        MyCatSchemaCollection dt = CreateParametersTable();
    ...
    private MyCatSchemaCollection Query(string table_name, string initial_where,
    ...
    public override MyCatSchemaCollection GetForeignKeys(string[] restrictions)
    {
    ...
    public override MyCatSchemaCollection GetForeignKeyColumns(string[] restrictions)
    {
    ...
    /// </summary>
    private static void InitParameterRow(MyCatSchemaRow procedure, MyCatSchemaRow parameter)
    {
    ...
    private static string GetDataTypeDefaults(string type, MyCatSchemaRow row)
    {
      string format = "({0},{1})";
    ...
    private static void ParseDataTypeSize(MyCatSchemaRow row, string size)
    {
      size = size.Trim('(', ')');
