...
{
  public sealed class MyCatConfiguration : ConfigurationSection
  {
    private static MyCatConfiguration settings
      = ConfigurationManager.GetSection("MySQL") as MyCatConfiguration;

    public static MyCatConfiguration Settings
    {
      get { return settings; }
    }
