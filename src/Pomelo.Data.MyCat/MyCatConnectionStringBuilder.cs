...
{
  public sealed partial class MyCatConnectionStringBuilder 
  {
    ...
    private static MyCatConnectionStringOptionCollection options = new MyCatConnectionStringOptionCollection();

    static MyCatConnectionStringBuilder()
    {
      // Server options
      ...
      options.Add(new MyCatConnectionStringOption("logging", null, typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("sharedmemoryname", "shared memory name", typeof(string), "MYSQL", false));
      options.Add(new MyCatConnectionStringOption("useoldsyntax", "old syntax,oldsyntax,use old syntax", typeof(bool), false, true,
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object value)
        {
          MyCatTrace.LogWarning(-1, "Use Old Syntax is now obsolete.  Please see documentation");
          msb.SetValue("useoldsyntax", value);
        },
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender)
        {
          return (bool)msb.values["useoldsyntax"];
        }
        ));
      options.Add(new MyCatConnectionStringOption("connectiontimeout", "connection timeout,connect timeout", typeof(uint), (uint)15, false,
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object Value)
        {
          ...
          // maximum (MyCatCommand.CommandTimeout uses the same technique
          uint timeout = Math.Min(value, Int32.MaxValue / 1000);
          if (timeout != value)
          {
            MyCatTrace.LogWarning(-1, "Connection timeout value too large ("
      ...
      options.Add(new MyCatConnectionStringOption("defaultcommandtimeout", "command timeout,default command timeout", typeof(uint), ( uint )30, false));
      options.Add(new MyCatConnectionStringOption("usedefaultcommandtimeoutforef", "use default command timeout for ef", typeof(bool), false, false));

      // authentication options
      options.Add(new MyCatConnectionStringOption("user id", "uid,username,user name,user,userid", typeof(string), "", false));
      options.Add(new MyCatConnectionStringOption("password", "pwd", typeof(string), "", false));
      options.Add(new MyCatConnectionStringOption("persistsecurityinfo", "persist security info", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("encrypt", null, typeof(bool), false, true,
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object value)
        {
          // just for this case, reuse the logic to translate string to bool
          sender.ValidateValue(ref value);
          MyCatTrace.LogWarning(-1, "Encrypt is now obsolete. Use Ssl Mode instead");
          msb.SetValue("Ssl Mode", ( bool)value ? MyCatSslMode.Prefered : MyCatSslMode.None);
        },
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender)
        {
          return msb.SslMode != MyCatSslMode.None;
        }
        ));
      options.Add(new MyCatConnectionStringOption("certificatefile", "certificate file", typeof(string), null, false));
      options.Add(new MyCatConnectionStringOption("certificatepassword", "certificate password", typeof(string), null, false));
      options.Add(new MyCatConnectionStringOption("certificatestorelocation", "certificate store location", typeof(MyCatCertificateStoreLocation), MyCatCertificateStoreLocation.None, false));
      options.Add(new MyCatConnectionStringOption("certificatethumbprint", "certificate thumb print", typeof(string), null, false));
      options.Add(new MyCatConnectionStringOption("integratedsecurity", "integrated security", typeof(bool), false, false,
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object value)
        {
          if (!Pomelo.Data.Common.Platform.IsWindows())
            throw new MyCatException("IntegratedSecurity is supported on Windows only");
      ...
      // Other properties
      options.Add(new MyCatConnectionStringOption("allowzerodatetime", "allow zero datetime", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("convertzerodatetime", "convert zero datetime", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("useusageadvisor", "use usage advisor,usage advisor", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("procedurecachesize", "procedure cache size,procedure cache,procedurecache", typeof(uint), ( uint )25, false));
      options.Add(new MyCatConnectionStringOption("useperformancemonitor", "use performance monitor,useperfmon,perfmon", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("ignoreprepare", "ignore prepare", typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("useprocedurebodies", "use procedure bodies,procedure bodies", typeof(bool), true, true,
        delegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object value)
        {
          sender.ValidateValue(ref value);
          MyCatTrace.LogWarning(-1, "Use Procedure Bodies is now obsolete.  Use Check Parameters instead");
      ...
      options.Add(new MyCatConnectionStringOption("autoenlist", "auto enlist", typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("respectbinaryflags", "respect binary flags", typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("treattinyasboolean", "treat tiny as boolean", typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("allowuservariables", "allow user variables", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("interactivesession", "interactive session,interactive", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("functionsreturnstring", "functions return string", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("useaffectedrows", "use affected rows", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("oldguids", "old guids", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("keepalive", "keep alive", typeof(uint), (uint)0, false));
      options.Add(new MyCatConnectionStringOption("sqlservermode", "sql server mode", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("tablecaching", "table cache,tablecache", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("defaulttablecacheage", "default table cache age", typeof(int), ( int ) 60, false));
      options.Add(new MyCatConnectionStringOption("checkparameters", "check parameters", typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("replication", null, typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("exceptioninterceptors", "exception interceptors", typeof(string), null, false));
      options.Add(new MyCatConnectionStringOption("commandinterceptors", "command interceptors", typeof(string), null, false));
      options.Add(new MyCatConnectionStringOption("includesecurityasserts", "include security asserts", typeof(bool), false, false));

      // pooling options
      options.Add(new MyCatConnectionStringOption("connectionlifetime", "connection lifetime", typeof(uint), ( uint )0, false));
      options.Add(new MyCatConnectionStringOption("pooling", null, typeof(bool), true, false));
      options.Add(new MyCatConnectionStringOption("minpoolsize", "minimumpoolsize,min pool size,minimum pool size", typeof(uint), (uint)0, false));
      options.Add(new MyCatConnectionStringOption("maxpoolsize", "maximumpoolsize,max pool size,maximum pool size", typeof(uint), (uint)100, false));
      options.Add(new MyCatConnectionStringOption("connectionreset", "connection reset", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("cacheserverproperties", "cache server properties", typeof(bool), false, false));

      // language and charset options
      options.Add(new MyCatConnectionStringOption("characterset", "character set,charset", typeof(string), "", false));
      options.Add(new MyCatConnectionStringOption("treatblobsasutf8", "treat blobs as utf8", typeof(bool), false, false));
      options.Add(new MyCatConnectionStringOption("blobasutf8includepattern", null, typeof(string), "", false));
      options.Add(new MyCatConnectionStringOption("blobasutf8excludepattern", null, typeof(string), "", false));
      options.Add(new MyCatConnectionStringOption("sslmode", "ssl mode", typeof(MyCatSslMode), MyCatSslMode.None, false));
    }
    ...
    public MyCatConnectionStringBuilder(string connStr)
      : base()
    {
      lock (this)
      {
    ...
    [RefreshProperties(RefreshProperties.All)]
    public MyCatConnectionProtocol ConnectionProtocol
    {
      get { return (MyCatConnectionProtocol)values["protocol"]; }
    ...
    [Description(@"The default timeout that MyCatCommand objects will use
                     unless changed.")]
    [RefreshProperties(RefreshProperties.All)]
    ...
    {
      get { return SslMode != MyCatSslMode.None; }
      set
      {
        SetValue("Ssl Mode", value ? MyCatSslMode.Prefered : MyCatSslMode.None);
      }
    }
    ...
    [DefaultValue(MyCatCertificateStoreLocation.None)]
    public MyCatCertificateStoreLocation CertificateStoreLocation
    {
      get { return (MyCatCertificateStoreLocation)values["certificatestorelocation"]; }
    ...
    [Description("The list of interceptors that can triage thrown MyCatExceptions.")]
    ...
    {
      get { return (MyCatSslMode)values["sslmode"]; }
    ...
    [Description("Enforces the command timeout of EFMyCatCommand to the value provided in 'DefaultCommandTimeout' property")]
    [DefaultValue(false)]
    ...
    {
      get { MyCatConnectionStringOption opt = GetOption(keyword); return opt.Getter( this, opt ); }
      set { MyCatConnectionStringOption opt = GetOption(keyword); opt.Setter( this, opt, value); }
    }
    ...
    {
      MyCatConnectionStringOption option = GetOption(keyword);
    ...
    private MyCatConnectionStringOption GetOption(string key)
    {
      MyCatConnectionStringOption option = options.Get(key);
      if (option == null)
    ...
    {
      MyCatConnectionStringOption option = options.Get(keyword);
      return option != null;
    }
    ...
    {
      MyCatConnectionStringBuilder other = obj as MyCatConnectionStringBuilder;
      if( obj == null )
        return false;
  ...
  class MyCatConnectionStringOption
  {
    public MyCatConnectionStringOption(string keyword, string synonyms, Type baseType, object defaultValue, bool obsolete, 
    ...
    public delegate void SetterDelegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender, object value);
    public delegate object GetterDelegate(MyCatConnectionStringBuilder msb, MyCatConnectionStringOption sender);
    ...
    public void Clean(MyCatConnectionStringBuilder builder)
    {
  ...
  internal class MyCatConnectionStringOptionCollection : Dictionary<string, MyCatConnectionStringOption>
  {
    List<MyCatConnectionStringOption> options;

    internal List<MyCatConnectionStringOption> Options { get { return options; } }

    internal MyCatConnectionStringOptionCollection() : base( StringComparer.OrdinalIgnoreCase )
    {
      options = new List<MyCatConnectionStringOption>();
    }

    internal void Add(MyCatConnectionStringOption option)
    {
      options.Add(option);
    ...
    internal MyCatConnectionStringOption Get(string keyword)
    {
      MyCatConnectionStringOption option = null;
