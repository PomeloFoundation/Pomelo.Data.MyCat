...
{
    /// <include file='docs/MyCatDataReader.xml' path='docs/ClassSummary/*'/>
    public sealed partial class MyCatDataReader : IDisposable
    {
        // The DataReader should always be open when returned to the user.
        private bool isOpen = true;

        private CommandBehavior commandBehavior;
        public MyCatCommand command;
        ...
        /// <summary>
        /// Gets a value indicating whether the MyCatDataReader contains one or more rows.
        /// </summary>
        ...
        /// In C#, this property is the indexer for the MyCatDataReader class.
        /// </summary>
        ...
        ///	[C#] In C#, this property is the indexer for the MyCatDataReader class.
        /// </summary>
        ...
        /// <summary>
        /// Closes the MyCatDataReader object.
        /// </summary>
#if NET451
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetMyCatDateTime/*'/>
        public MyCatDateTime GetMyCatDateTime(string column)
        {
            return GetMyCatDateTime(GetOrdinal(column));
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetMyCatDateTime/*'/>
        public MyCatDateTime GetMyCatDateTime(int column)
        {
            return (MyCatDateTime)GetFieldValue(column, true);
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetDateTimeS/*'/>
        ...
        public MyCatDecimal GetMyCatDecimal(string column)
        {
            return GetMyCatDecimal(GetOrdinal(column));
        }

        public MyCatDecimal GetMyCatDecimal(int i)
        {
            return (MyCatDecimal)GetFieldValue(i, false);
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetDecimalS/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetDoubleS/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetFloatS/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetGuidS/*'/>
        public Guid GetGuid(string column)
        {
            return GetGuid(GetOrdinal(column));
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetGuid/*'/>
        public override Guid GetGuid(int i)
        {
            ...
            Throw(new MyCatException(Resources.ValueNotSupportedForGuid));
            return Guid.Empty; // just to silence compiler
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetInt16S/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetInt32S/*'/>
        public Int32 GetInt32(string column)
        {
            return GetInt32(GetOrdinal(column));
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetInt32/*'/>
        public override Int32 GetInt32(int i)
        {
            IMyCatValue v = GetFieldValue(i, true);
            if (v is MyCatInt32)
                return ((MyCatInt32)v).Value;

            return (Int32)ChangeType(v, i, typeof(Int32));
        }

        /// <include file='docs/MyCatDataReader.xml' path='docs/GetInt64S/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetStringS/*'/>
        ...
        /// <include file='docs/MyCatDataReader.xml' path='docs/GetUInt16/*'/>
        ...
        {
            if (!isOpen)
                Throw(new MyCatException(Resources.NextResultIsClosed));
            ...
            catch (MyCatException ex)
            {
                if (ex.IsFatal)
                    connection.Abort();
                if (ex.Number == 0)
                    throw new MyCatException(Resources.FatalErrorReadingResult, ex);
        ...
        /// <summary>
        /// Advances the MyCatDataReader to the next record.
        /// </summary>
        /// <returns></returns>
        public override bool Read()
        {
            if (!isOpen)
                Throw(new MyCatException("Invalid attempt to Read when reader is closed."));
            if (resultSet == null)
                return false;
            ...
            catch (MyCatException ex)
            {
                ...
                throw new MyCatException(Resources.FatalErrorDuringRead, ex);
            }
        }
        ...
        private void ClearKillFlag()
        {
            ...
            MyCatCommand dummyCommand = new MyCatCommand(dummyStatement, connection);
            ...
            {
                if (ex.Number != (int)MyCatErrorCode.NoSuchTable) throw;
            }
        }
