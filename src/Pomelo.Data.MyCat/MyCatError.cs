...
namespace Pomelo.Data.MyCat
{
  ...
  public class MyCatError
  {
    ...
    public MyCatError(string level, int code, string message)
    {
      this.level = level;
      this.code = code;
  ...
  public enum MyCatErrorCode
  {
    ...
    ///<summary>The server is out of resources, check if MyCat or some other process is using all available memory.</summary>
