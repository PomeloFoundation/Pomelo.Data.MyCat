...
namespace Pomelo.Data.MyCat
{
  ...
  public class MyCatBulkLoader
  {
    ...
    private MyCatBulkLoaderPriority priority;
    private MyCatBulkLoaderConflictOption conflictOption;
    private List<string> columns;
    private List<string> expressions;

    public MyCatBulkLoader(MyCatConnection connection)
    {
      ...
      ConflictOption = MyCatBulkLoaderConflictOption.None;
    ...
    public MyCatBulkLoaderConflictOption ConflictOption
    {
    ...
    public MyCatBulkLoaderPriority Priority
    {
      get { return priority; }
      set { priority = value; }
    }
    ...
    private string BuildSqlCommand()
    {
      ...
      if (Priority == MyCatBulkLoaderPriority.Low)
        sql.Append("LOW_PRIORITY ");
      else if (Priority == MyCatBulkLoaderPriority.Concurrent)
      ...
      if (ConflictOption == MyCatBulkLoaderConflictOption.Ignore)
        sql.Append("IGNORE ");
      else if (ConflictOption == MyCatBulkLoaderConflictOption.Replace)
        sql.Append("REPLACE ");
  ...
  /// 
  /// </summary>
  public enum MyCatBulkLoaderPriority
  {
    /// <summary>
  ...
  /// 
  /// </summary>
  public enum MyCatBulkLoaderConflictOption
  {
    /// <summary>
