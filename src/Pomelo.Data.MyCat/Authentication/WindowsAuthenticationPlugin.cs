...
#endif
    internal class MyCatWindowsAuthenticationPlugin : MyCatAuthenticationPlugin
    {
        ...
        protected override void CheckConstraints()
        {
            ...
            if (!String.IsNullOrEmpty(platform))
                throw new MyCatException(String.Format(Resources.WinAuthNotSupportOnPlatform, platform));
#endif
        ...
        private void AcquireCredentials()
        {
            ...
            int ss = AcquireCredentialsHandle(null, "Negotiate", SECPKG_CRED_OUTBOUND,
                    ...
                    ref lifetime);
            if (ss != SEC_E_OK)
                throw new MyCatException("AcquireCredentialsHandle failed with errorcode" + ss);
        }
